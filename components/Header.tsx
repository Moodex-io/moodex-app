    ...
    <div className="border-b border-white/10 bg-black/20 backdrop-blur supports-[backdrop-filter]:bg-black/25">
      <header className="container flex h-14 md:h-16 items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <div
            className="h-7 w-7 rounded-lg bg-gradient-to-br from-cyan-400 to-fuchsia-500"
            aria-hidden
          />
          <span className="font-heading text-lg tracking-wider text-white">
            MOODEX <span className="text-cyan-300">LABS</span>
          </span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-teal-200/80">
          ...
          <a href="#highlights" className="hover:text-teal-100">Highlights</a>
